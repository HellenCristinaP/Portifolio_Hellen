...
function App() {
  ...
  return (
    <div class="mx-auto">
      <nav class="fixed top-0 w-full bg-purple-800 px-15 py-2 border-b-2 border-amber-400 shadow-md sm:hidden lg:px-40" id='nav'>
      ...
      <header class="bg-gradient-to-t from to-65% to-purple-800 px-8 pt-15 lg:px-40" id='home'>
      ...
      <main class="px-8 pt-15 lg:px-40">
        ...
        <a href="./curriculo/Curriculo_Hellen_Estágio_FrontEnd.pdf" download="./curriculo/Curriculo_Hellen_Estágio_FrontEnd.pdf" class="cursor-pointer py-1 px-4 mx-2 bg-purple-800 text-[#f1f1f1]/50 rounded-3xl hover:text-[#f1f1f1] hover:bg-purple-800/70 transition font-semibold shadow-md sm:py-2.5">Baixar curriculo</a>

        <h2 class="py-5" id='projetos'>Projetos</h2>
        <article class="grid grid-cols-1 gap-3 px-5 pt-2 md:grid-cols-2">
